...
print(df_flashbay.duplicated().sum())
...
#location: Identifying which index the faulty value of 'Nov 12, 2020' belongs to
index_wrong_location = df_flashbay.loc[df_flashbay['location'] == 'Nov 12, 2020'].index[0]
print("The faulty location value is at user: ", index_wrong_location)
problematic_username = df_flashbay.loc[index_wrong_location, 'username']
problematic_page = df_flashbay.loc[index_wrong_location, 'page_number']

print(f"The problematic username '{problematic_username}' was found on page {problematic_page}")
...
#python3 data_processing_trustpilot.py